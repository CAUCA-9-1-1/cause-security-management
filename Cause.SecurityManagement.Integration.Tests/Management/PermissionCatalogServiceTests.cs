...
public class PermissionCatalogServiceTests : IntegrationTestBase
{
    ...
    [Test]
    public void GetPermissions_ShouldMapModulePermissionsAndOrderBySequence()
    {
        ...
        var catalog = Service.GetPermissions().Where(permission => permission.Tag.StartsWith(token)).ToList();
